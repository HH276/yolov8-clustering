...
#-------------------------------------------------------------------#
# classes_path        = '/cvgroup/home/wurx/Datasets/KITTI/training/classes.txt'
...
VOCdevkit_path  = 'VOC2012'

VOCdevkit_sets  = [('20240420', 'train'), ('20240420', 'val')]
...
def convert_annotation(year, image_id, list_file):
    print(os.path.join(VOCdevkit_path,'/Annotations/%s.xml'%(image_id)))
