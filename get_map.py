...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    VOCdevkit_path  = '/data4/czh/yolov8-cluster/yolov8-hard-clustering/datasets/RDD2022/United_States'
    #-------------------------------------------------------#
    #   结果输出的文件夹，默认为map_out
    #-------------------------------------------------------#
    map_out_path    = './map_out/Style/260711_test/United_States'

    image_ids = open(os.path.join(VOCdevkit_path, "ImageSets/Main/test_all.txt")).read().strip().split()
