...
# optimizer
parser.add_argument('--lr_DG_conf', type=float, default=0.0001)#
parser.add_argument('--lr_critic', type=float, default=0.0001)#判别器的能力都要比生成器的能力要强
parser.add_argument('--beta1', type=float, default=0.9)
parser.add_argument('--beta2', type=float, default=0.999)

# training configs
parser.add_argument('--training_type', type=str, default='Train')
# parser.add_argument('--results_path', type=str, default='./logs/20240307_avg_margin0_uncertain_nobase')
# parser.add_argument('--results_path', type=str, default='./logs/20240326_limited_domain_NOusa')
parser.add_argument('--results_path', type=str, default='./logs/testtest')
...
# parser.add_argument('--W_trip', type=int, default=0)
parser.add_argument('--W_trip', type=int, default=0.2)
parser.add_argument('--W_gen', type=int, default=0.7)
parser.add_argument('--W_intra', type=int, default=0.1)
parser.add_argument('--W_genave', type=int, default=1 / 3)
# parser.add_argument('--W_yolo', type=int, default=0.001)  # yolo 的bbox的损失值 的权重系数
...
if __name__ == "__main__":
    ...
    # model_path = './model_data/best_epoch_weights_baselineOld.pth'
    # ------------------------------------------------------#
    ...
    # val_annotation_path   = './20240326_chongzu_data_val_NOindia.txt'   
    # val_annotation_path   = './20240326_chongzu_data_val_NOus.txt'   
    ...
    FeatEmbdmodel = FeatEmbedder(in_channels=128, nettype=None).to("cuda")
    ...
    model = YoloBody(input_shape=input_shape, num_classes=num_classes, phi=phi, pretrained=pretrained).to('cuda')
    ...
    if model_path != '':
        ...
        load_key, no_load_key, temp_dict, temp_dict_backbone = [], [], {}, {}
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(model_train, model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step,
                          ...
                          FeatEmbder, Discriminator1, Discriminator2, Discriminator3, PreFeatExtorS1, PreFeatExtorS2,
                          PreFeatExtorS3,
