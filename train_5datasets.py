...
parser.add_argument('--results_path', type=str, default='./logs/5datasets_doamin/20240527_w_yolov8l_sgd')
...
parser.add_argument('--W_trip', type=int, default=0.3)
parser.add_argument('--W_gen', type=int, default=0.7)#原
# parser.add_argument('--W_gen', type=int, default=0.95)
parser.add_argument('--W_intra', type=int, default=0.1)
parser.add_argument('--W_genave', type=int, default=1 / 3)
parser.add_argument('--W_yolo', type=int, default=1.0)  # yolo 损失 的权重系数
...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------------#
    classes_path = '/cvgroup/home/wurx/Datasets/classes.txt'
    # ----------------------------------------------------------------------------------------------------------------------------#
    ...
    # model_path = '/cvgroup/home/wurx/yolov8_beifen/logs/3datasets_domain/together_3domain/best_epoch_weights.pth'
    # model_path = '/cvgroup/home/wurx/yolov8-pytorch-master/logs/5datasets_doamin/20240429_w_baseline/best_epoch_weights.pth'
    # ------------------------------------------------------#
    ...
    # ------------------------------------------------------#
    # 测试
    # train_annotation_path = '/cvgroup/home/wurx/Datasets/test_BDD100K_cityscapes_KITTI_train.txt'
    # val_annotation_path   = '/cvgroup/home/wurx/Datasets/test_BDD100K_cityscapes_KITTI_val.txt'   

    train_annotation_path = '/cvgroup/home/wurx/Datasets/BDD100K_cityscapes_KITTI_train.txt'
    val_annotation_path   = '/cvgroup/home/wurx/Datasets/BDD100K_cityscapes_KITTI_val.txt'   
    ...
    # FeatExtS1_restore = osp.join('/disk/home/wurx/yolov8-pytorch-master/results', 'Pre_train', 'snapshots', args.dataset1, 'Japan.pth')
    ...
    PreFeatExtorS1 = init_model(net=FeatExtmodel_pre1, init_type=args.init_type, restore='/cvgroup/home/wurx/yolov8_beifen/logs/3datasets_domain/BDD100K/best_epoch_weights.pth').to(device)#BDD10K
    PreFeatExtorS2 = init_model(net=FeatExtmodel_pre2, init_type=args.init_type, restore='/cvgroup/home/wurx/yolov8_beifen/logs/3datasets_domain/cityscapes/best_epoch_weights.pth').to(device)#cityscapes
    PreFeatExtorS3 = init_model(net=FeatExtmodel_pre3, init_type=args.init_type, restore='/cvgroup/home/wurx/yolov8_beifen/logs/3datasets_domain/KITTI/best_epoch_weights.pth').to(device)#KITTI
    ...
    if True:
        ...
        FeatEmbder     = DataParallel(FeatEmbdmodel)
